...
AI_EXTERN_C AI_STATIC_API
size_t
ai_hash(const void* buffer, size_t size, size_t seed);

AI_EXTERN_C AI_STATIC_API
uint64_t
ai_hash64(const void* buffer, uint64_t size, uint64_t seed);

AI_EXTERN_C AI_STATIC_API
uint32_t
ai_hash32(const void* buffer, uint32_t size, uint32_t seed);
